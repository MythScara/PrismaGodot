...
var specialist_info = {
	"Name": "Samurai",
	"Description": "Code driven legendary warriors, bound by honor and pride. A fight is only a fight when it is fought fair.",
	"Weapon": "Halberd",
	"Passive 1": {"Mind": "Gain immunity to [b]Petrify[/b]."},
	"Passive 2": {"Soul": "Increase [b]STE[/b] by [b]10 [/b]on [b]Melee Weapons[/b]."},
	"Passive 3": {"Heart": "Using a [b]Technique [/b]instantly recharges [b]Melee Weapons[/b]."},
	"Technique 1": {"Skill": "Increase [b]RCH[/b] by [b]20 [/b]on [b]Melee Weapons[/b].", "TD": 10, "TC": 30},
	"Technique 2": {"Special": "Next instance of [b]Physical Damage[/b] dealt is converted into [b]Health[/b].", "TD": "SU", "TC": 20},
	"Technique 3": {"Super": "All [b]Melee[/b] [b]Weapon [/b]hits register as [b]Weakpoint[/b].", "TD": "SU", "TC": 90}
}
...
var weapon_stats_m = {
	...
	"CRR": 0, "CRD": 0, "INF": 0, "SLS": 0, "PRC": 0, "FRC": 0,
	"Type": "Halberd", "Tier": "Diamond", "Element": null, "Quality": null, "Max Value": 100}
