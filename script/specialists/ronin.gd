...
var specialist_info = {
	"Name": "Ronin",
	"Description": "Skilled blade dancer with impeccable ability. Student of the sword with a desire to master all that it entails.",
	"Weapon": "Katana",
	"Passive 1": {"Mind": "Gain immunity to [b]Null[/b]."},
	"Passive 2": {"Soul": "Increase [b]DUR[/b] by [b]10 [/b]on [b]Melee Weapons[/b]."},
	"Passive 3": {"Heart": "Taking [b]Elemental Damage [/b]restores [b]2% Stamina[/b]. Can only occur once every [b]5 [/b]seconds."},
	"Technique 1": {"Skill": "Remove all Status Affliction of type Void.", "TD": "SU", "TC": 10},
	"Technique 2": {"Special": "Increase [b]PRC[/b] by [b]20[/b] on [b]Melee Weapons[/b].", "TD": 10, "TC": 40},
	"Technique 3": {"Super": "Gain [b]3[/b] stacks of [b]Unbreaking[/b].", "TD": "SU", "TC": 60}
}
...
var weapon_stats_m = {
	...
	"CRR": 0, "CRD": 0, "INF": 0, "SLS": 0, "PRC": 0, "FRC": 0,
	"Type": "Katana", "Tier": "Diamond", "Element": null, "Quality": null, "Max Value": 100}
