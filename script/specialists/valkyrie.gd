...
var specialist_info = {
	"Name": "Valkyrie",
	"Description": "Heavenly guards brought to bring balance to the world. Blessed be those who wish no harm amongst others.",
	"Weapon": "Warhammer",
	"Passive 1": {"Mind": "When [b]Health[/b] drops below [b]50%[/b], gain [b]2[/b] stacks of [b]Unbreaking[/b]. Does not stack with itself."},
	"Passive 2": {"Soul": "Increase [b]BLK[/b] by [b]10 [/b]on [b]Melee Weapons[/b]."},
	"Passive 3": {"Heart": "Using a [b]Support Item [/b]reduces [b]Summon[/b] cooldown by [b]10%[/b]."},
	"Technique 1": {"Skill": "Increase [b]BLK[/b] by [b]20 [/b]on [b]Melee Weapons[/b].", "TD": 10, "TC": 30},
	"Technique 2": {"Special": "Next instance of [b]Magic Damage[/b] is nullified.", "TD": "SU", "TC": 20},
	"Technique 3": {"Super": "Gain [b]3[/b] stacks of [b]Manawall[/b].", "TD": "SU", "TC": 60}
}
...
var weapon_stats_m = {
	...
	"CRR": 0, "CRD": 0, "INF": 0, "SLS": 0, "PRC": 0, "FRC": 0,
	"Type": "Warhammer", "Tier": "Diamond", "Element": null, "Quality": null, "Max Value": 100}
