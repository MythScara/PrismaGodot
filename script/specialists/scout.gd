...
var specialist_info = {
	"Name": "Scout",
	"Description": "Eagle eyed retainer of the lands, the first line of both offense and defense. None shall escape their gaze.",
	"Weapon": "Sniper Rifle",
	"Passive 1": {"Mind": "Gain immunity to [b]Exhaust[/b]."},
	"Passive 2": {"Soul": "Increase [b]AC[/b] by [b]10 [/b]on [b]Ranged Weapons[/b]."},
	"Passive 3": {"Heart": "Using a [b]Summon [/b]instantly reloads [b]Ranged Weapons[/b] and starts [b]Stamina Recovery[/b]."},
	"Technique 1": {"Skill": "Increase [b]RNG[/b] by [b]20 [/b]on [b]Ranged Weapons[/b].", "TD": 10, "TC": 30},
	"Technique 2": {"Special": "Increase [b]CRR[/b] by [b]20 [/b]on [b]Ranged Weapons[/b].", "TD": 10, "TC": 40},
	"Technique 3": {"Super": "Gain [b]3[/b] stacks of [b]Circulation[/b].", "TD": "SU", "TC": 60}
}
...
var weapon_stats_r = {
	...
	"Type": "Sniper Rifle", "Tier": "Diamond", "Element": null, "Quality": null, "Max Value": 100}
