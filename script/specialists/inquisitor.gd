...
var specialist_name = "Inquisitor"
var active = false
var cur_level = 0
...
var mind_signal = ""
var soul_signal = ""
var heart_signal = "Battle Magic Cast"

var specialist_info = {
	"Name": "Inquisitor",
	"Description": "Powered by a desire to rule, with an insatiable hunger to conquest. The world will be perfected only when it is all within their grasp.",
	"Weapon": "Battle Axe",
	"Passive 1": {"Mind": "Gain immunity to [b]Siphon[/b]."},
	"Passive 2": {"Soul": "Increase [b]RCH[/b] by [b]10 [/b]on [b]Melee Weapons[/b]."},
	"Passive 3": {"Heart": "Casting [b]Battle Magic [/b]reduces [b]Technique [/b]cooldowns by [b]10%[/b]."},
	"Technique 1": {"Skill": "Remove all Status Affliction of type Spirit.", "TD": "SU", "TC": 10},
	"Technique 2": {"Special": "Increase [b]FRC[/b] by [b]20 [/b]on [b]Melee Weapons[/b].", "TD": 10, "TC": 40},
	"Technique 3": {"Super": "Gain [b]3[/b] stacks of [b]Rage[/b].", "TD": "SU", "TC": 60}
}
...
var weapon_stats_m = {
	...
	"CRR": 0, "CRD": 0, "INF": 0, "SLS": 0, "PRC": 0, "FRC": 0,
	"Type": "Battle Axe", "Tier": "Diamond", "Element": null, "Quality": null, "Max Value": 100}
