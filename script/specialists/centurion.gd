...
var specialist_info = {
	"Name": "Centurion",
	"Description": "Heavily armored battalion soldier with impregnable defensive capabilities. The strongest is that which never yields.",
	"Weapon": "Shield",
	"Passive 1": {"Mind": "Gain immunity to [b]Combust[/b]."},
	"Passive 2": {"Soul": "Increase [b]WCP[/b] by [b]10 [/b]on all weapons."},
	"Passive 3": {"Heart": "Taking [b]Magic Damage [/b]restores [b]2% Overshield[/b]. Can only occur once every [b]5 [/b]seconds."},
	"Technique 1": {"Skill": "Regenerate [b]2% Overshield [/b]per second.", "TD": 5, "TC": 20},
	"Technique 2": {"Special": "Next instance of [b]Physical Damage[/b] is nullified.", "TD": "SU", "TC": 20},
	"Technique 3": {"Super": "Gain [b]3[/b] stacks of [b]Bulwark[/b].", "TD": "SU", "TC": 60}
}
