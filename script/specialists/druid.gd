...
var specialist_info = {
	"Name": "Druid",
	"Description": "Spiritually trained wizards with power intertwined with that of the natural world. The fruit of labor is not power but peace.",
	"Weapon": "Polearm",
	"Passive 1": {"Mind": "Dealing [b]Magic Damage [/b]grants [b]1[/b] stack of [b]Manawall[/b]. Does not stack with itself."},
	"Passive 2": {"Soul": "Increase [b]SLS[/b] by [b]5 [/b]on all weapons."},
	"Passive 3": {"Heart": "Casting [b]Support Magic [/b]reduces [b]Summon [/b]cooldown by [b]10%[/b]."},
	"Technique 1": {"Skill": "Regenerate [b]2% Magic Power[/b] per second.", "TD": 5, "TC": 20},
	"Technique 2": {"Special": "Next instance of [b]Magic Damage[/b] dealt is converted into [b]Health[/b].", "TD": "SU", "TC": 20},
	"Technique 3": {"Super": "Gain [b]3[/b] stacks of [b]Lightborn[/b].", "TD": "SU", "TC": 60}
}
...
var weapon_stats_m = {
	...
	"CRR": 0, "CRD": 0, "INF": 0, "SLS": 0, "PRC": 0, "FRC": 0,
	"Type": "Polearm", "Tier": "Diamond", "Element": null, "Quality": null, "Max Value": 100}
