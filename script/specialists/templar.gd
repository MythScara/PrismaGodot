...
var specialist_info = {
	...
	"Weapon": "Staff",
	"Passive 1": {"Mind": "Killing an enemy grants [b]2 [/b]stacks of [b]Energized[/b]. Does not stack with itself."},
	"Passive 2": {"Soul": "Increase [b]PRC[/b] by [b]5 [/b]on all weapons."},
	"Passive 3": {"Heart": "Regenerate [b]100 Magic Power[/b] per second."},
	"Technique 1": {"Skill": "Regenerate [b]2% Health [/b]per second.", "TD": 5, "TC": 20},
	"Technique 2": {"Special": "[b]Magic Power[/b] depleted is converted into [b]Overshield[/b].", "TD": 15, "TC": 60},
	"Technique 3": {"Super": "Gain [b]3[/b] stacks of [b]Soulborn[/b].", "TD": "SU", "TC": 60}
}
...
var weapon_stats_m = {
	...
	"CRR": 0, "CRD": 0, "INF": 0, "SLS": 0, "PRC": 0, "FRC": 0,
	"Type": "Staff", "Tier": "Diamond", "Element": null, "Quality": null, "Max Value": 100}
