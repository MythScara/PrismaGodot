...
var mind_signal = "Health Below 20%"
var soul_signal = ""
var heart_signal = "Physical Damage Taken"

var specialist_info = {
	"Name": "Monk",
	"Description": "Patient warrior who prefers pinpoint strikes using their body and mind. The gods have blessed us with a powerful weapon, I need not use any other.",
	"Weapon": "Gauntlet",
	"Passive 1": {"Mind": "When [b]Health[/b] drops below [b]20%[/b], gain [b]3[/b] stacks of [b]Resist[/b]. Does not stack with itself."},
	"Passive 2": {"Soul": "Increase [b]ASP[/b] by [b]10 [/b]on [b]Melee Weapons[/b]."},
	"Passive 3": {"Heart": "Taking [b]Physical Damage [/b]restores [b]2% Magic Power[/b]. Can only occur once every [b]5 [/b]seconds."},
	"Technique 1": {"Skill": "Remove [b]1[/b] [b]Status Affliction[/b] of any type.", "TD": "SU", "TC": 10},
	"Technique 2": {"Special": "[b]Fatal Damage[/b] is nullified and [b]Health[/b] is set to [b]1[/b].", "TD": 15, "TC": 60},
	"Technique 3": {"Super": "Gain [b]3[/b] stacks of [b]Earthborn[/b].", "TD":"SU", "TC": 60}
}
...
var weapon_stats_m = {
	...
	"CRR": 0, "CRD": 0, "INF": 0, "SLS": 0, "PRC": 0, "FRC": 0,
	"Type": "Gauntlet", "Tier": "Diamond", "Element": null, "Quality": null, "Max Value": 100}
