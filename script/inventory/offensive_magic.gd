...
@onready var top = $OffensiveMagicTop/Image
@onready var right = $OffensiveMagicRight/Image
@onready var left = $OffensiveMagicLeft/Image
@onready var bottom = $OffensiveMagicBottom/Image
...
func image_set(type):
	if type != null and PlayerInventory.current_inventory["Battle Magic"][type] != null:
		var image = PlayerInventory.current_inventory["Battle Magic"][type].keys()[0]
		var path = "res://asset/magic_icons/" + image.to_lower() + ".png"
...
func _on_offensive_magic_top_pressed():
	display_field("Top")

func _on_offensive_magic_right_pressed():
	display_field("Right")

func _on_offensive_magic_left_pressed():
	display_field("Left")

func _on_offensive_magic_bottom_pressed():
