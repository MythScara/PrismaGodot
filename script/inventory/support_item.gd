...
@onready var top = $SupportItemTop/Image
@onready var right = $SupportItemRight/Image
@onready var left = $SupportItemLeft/Image
@onready var bottom = $SupportItemBottom/Image
