...
var species_data = {
	...
	"Bonus1": "- [b]Repair[/b] cost decreased by [b]20%[/b]",
	"Bonus2": "- [b]Forge[/b] success rate increased by [b]5%[/b] and cost decreased by [b]10%[/b]",
	"Bonus3": "- [b]Transport[/b] cost decreased by [b]50%[/b]",
...
func _update_information(key: String):
	...
	bonusOne.bbcode_text = species["Bonus1"]
	bonusTwo.bbcode_text = species["Bonus2"]
